...
2. Search existing atomic notes for related concepts using `obsidian search query="<topic>"`
...
4. Create properly formatted atomic notes following these rules:
   ...
   - Place in 01-atomic/ directory using `obsidian create path="01-atomic/<Note Name>.md" content="<content>"`
...
6. After creating notes, append ONE brief sentence to today's daily note using `obsidian daily:append content="<sentence>"`
...
For any Obsidian operation not covered above, run `obsidian help` or `obsidian help <command>` to discover the right command.
